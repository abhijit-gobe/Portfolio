  ...
  return (
    <section className="pb-16 lg:py-24">
      <div className="container">
        ...
        <div className="flex flex-col mt-10 md:mt-[86px] gap-20">
          {portfolioProjects.map(project => (
            <Card key={project.title} className=" px-8 pt-8 md:pt-12 md:px-10  lg:pt-16 lg:px-20 pb-0">
                ...
                <div className="bg-gradient-to-r from-emerald-300 to-sky-400 text-transparent inline-flex bg-clip-text gap-2 font-bold uppercase tracking-widest text-sm">
